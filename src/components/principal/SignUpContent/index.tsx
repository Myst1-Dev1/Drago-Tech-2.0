...
export default function SignUpContent() {
    ...
    async function registerActionWithToastMessage(prevState: any, formData: FormData) {
    ...
    return (
        <>
            <div className="px-4 lg:px-28 py-16 flex flex-col justify-center items-center">
                ...
                <form action={formAction} className="max-w-[600px] w-full flex flex-col">
                    ...
                    <button className="p-3 rounded-md w-full text-white font-bold bg-red-500 transition-all duration-500 hover:bg-red-700">
                        {pending ? 
                            <div role="status">
