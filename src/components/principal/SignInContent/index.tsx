...
export default function SignInContent() {
    ...
    const [formState, formAction, pending] = useFormState(handleLogin, { success: false });
    ...
    return (
        <>
            <div className="px-4 lg:px-28 py-16 flex flex-col justify-center items-center">
                ...
                <form action={formAction} className="max-w-96 w-full flex flex-col">
                    <input className="outline-none p-4 rounded-md w-full border border-gray-300 mb-5" type="text" placeholder="Email" name="email" />
                    ...
                    <span className="text-red-600 mb-3 font-bold m-auto">{ formState.message }</span>
                    : ''}
