...
export function HomeCarousel() {
    ...
    return (
        <>
            {/* <div className="home-carousel px-4 lg:px-16 relative z-20 flex items-center justify-center"> */}
            <Swiper
                ...
                {carouselData.map((data) => (
                    ...
                    <div className="flex-wrap px-4 lg:px-16 relative z-20 flex flex-col lg:flex-row items-center justify-center gap-5">
                        <Image
                        className="rounded-[13px] lg:max-w-[700px] w-full h-[400px] object-cover"
                        src={data.slide}
                        width={700}
                        height={400}
                            ...
                            <div className="flex m-auto gap-5">
                                ...
                                <div className="border-b border-[#EBEBEB] pb-3 flex flex-col gap-3">
                                    ...
                                    <div className="overflow-hidden">
                                        <p className="text-[#777778]">{data.description}</p>
                ...
                {/* <svg className="absolute top-0 z-0" width="100%" height="100%" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" overflow="auto" shape-rendering="auto" fill="#ffffff">
                    <defs>
                    <path id="wavepath" d="M 0 2000 0 500 Q 119.5 410 239 500 t 239 0 239 0 239 0 239 0 239 0 239 0  v1000 z" />
                    <path id="motionpath" d="M -478 0 0 0" /> 
                    </defs>
                    <g >
                    <use xlinkHref="#wavepath" y="407" fill="#fff1f2">
                    <animateMotion
                        dur="5s"
