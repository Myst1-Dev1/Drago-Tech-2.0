        ...
        <>    
            <div className="border-b border-gray-300 pb-1 w-full flex justify-between items-center">
                ...
                <button onClick={() => {
                    ...
                    setTypeForm('create');
                }} className="font-semibold text-white p-2 rounded-lg my-2 h-fit mr-4 bg-red-500 w-fit transition-all duration-500 hover:bg-red-700">
            ...
            {openProductForm === false
                        ...
                        <div key={product.id} className="relative max-w-60 w-full p-3 grid grid-cols-1 place-items-center">
                            ...
                            <div className="flex gap-3 absolute top-1 right-1">
                                <span 
                                    ...
                                    className="bg-green-500 text-white rounded-md cursor-pointer h-7 text-sm w-7 grid place-items-center transition-all duration-500 hover:brightness-90"><FaPencilAlt /></span>
                ...
                :
                <>
                    {typeForm === 'create' && <CreateProductForm />}
                    {typeForm === 'update' && <UpdateProductForm products={products} productId={productId} />}
                </>
            }
        </>
    )
